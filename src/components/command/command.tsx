...
function CommandDialog({
  ...
  // Forwarded to the cmdk root: `shouldFilter=false` disables filtering; `filter`
  // supplies a custom scorer (quick-open ranks by name/breadcrumb/url). cmdk owns
  // the highlight + Enter selection when it does the filtering.
